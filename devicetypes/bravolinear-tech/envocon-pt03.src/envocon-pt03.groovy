 ...
 *  EnvoCon-PT03
 *
 *  Copyright 2020 Bravolinear Tech
 *
...
/*
metadata {
    definition (name: "Salus FC600", namespace: "Bravolinear", author: "Bravolinear") {
//        capability "Actuator"
//        capability "Battery"
...
//        fingerprint profileId: "0104", endpointId: "09", inClusters: "0000,0003,0004,0005,0201,0202,0204,0402,FC04,FC06,FC09", outClusters: "000A, 0019", manufacturer: "Bravolinear", model: "PT-01", deviceJoinName: "EnvoCon" //Zen Thermostat
    }
...
private getATTRIBUTE_PROGRAMMING_OPERATION_MODE()      { 0x0025 }
...
private getTypeBOOLEAN() { 0x10 }
private getTypeBITMAP8() { 0x18 }
private getTypeINT8U() { 0x20 }
private getTypeINT16U() { 0x21 }
private getTypeINT16() { 0x29 }
private getTypeENUM8() { 0x30 }
private getTypeCHARSTR() { 0x42 }
...
*/ 
metadata {
	definition (name: "EnvoCon-PT03", namespace: "Bravolinear Tech", author: "Bravolinear Tech", cstHandler: true) {
		capability "Temperature Measurement"
		capability "Thermostat Cooling Setpoint"
		capability "Thermostat Fan Mode"
		capability "Thermostat Heating Setpoint"
...
// handle commands
def setCoolingSetpoint(Degree) {
	log.debug "Executing 'setCoolingSetpoint' to $Degree"
...
def setThermostatFanMode(Mode) {
	log.debug "Executing 'setThermostatFanMode' to $Mode"
	// TODO: handle 'setThermostatFanMode' command
}

def setHeatingSetpoint(Degree) {
	log.debug "Executing 'setHeatingSetpoint' to $Degree"
...
def setThermostatMode(Mode) {
	log.debug "Executing 'setThermostatMode' to $Mode"
